...
headers = new HttpHeaders({
  ...
  GetPlanificacionDetalleByGrupoAndPlanificacion(grupoID: number, planificacion: number): Observable<PlanificacionDetalle[]> {
    return this.http.get<PlanificacionDetalle[]>(this.baseUrl + 'GetPlanificacionDetalleByGrupoAndPlanificacion'  + '?='  + grupoID + '?planificacion' + planificacion );
  }
  ...
  deletePlanificacionEvaluacion(id: number) {
    return this.http.delete(this.baseUrl + 'deletePlanificacionEvaluacion/'  + id);
  }
