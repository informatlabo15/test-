    ...
    if (grupoSelected > 0 ) {
      this.planificacionService.getPlanificacionDetalleByGrupo(grupoSelected).subscribe(
        (  planificacionDetalle: PlanificacionDetalle[] ) => {
          ...
          console.log(this.planificacionDetalles);
          if (this.planificacionDetalles.length > 0 ) {
            ...
            this.planificacionDetalleForm.setControl('planificacionEstudiante', this.fb.array([]));
          }
        }
      );
  ...
  onDeleted(planificacion: Planificacion) {
    this.alertify.confirm('Desea Eliminar el Planificacion: ' + planificacion.nombre + '?', () => {
      this.planificacionService.delete(planificacion.id).subscribe(() => {
        ...
        this.planificacionDetalleForm.reset();
        // this.getPlanificacionDetalle();
        this.disabledViews();
        this.isToList = true;
        this.planificacionDetalleForm.reset();
