...
//        this.router.navigate(['/horarios']);
  ...
  updateHorario(horario: Horario) {
     ...
     this.horarioForm.patchValue({
      ...
      horaEntrada: this.dateFormat.transform(new Date(horario.horaEntrada)),
      horaSalida: this.dateFormat.transform(new Date(horario.horaSalida)),
      orden: horario.orden,
  ...
  prepareSaveHorario(): Horario {
    ...
    const saveHorario: Horario = {
      ...
      horaEntrada: formModel.horaEntrada as Date,
      estado: formModel.estado as boolean,
      horaSalida: formModel.horaSalida as Date,
      orden: formModel.orden as number
    };
      return saveHorario;
  }
