...
export class PlanificacionEvaluacionComponent  implements OnInit {
  ...
  get planificacionesControls(): FormArray {
    return this.planificacionEvaluacionForm.get('planificacionesControls') as FormArray;
  }

  // get planificacionEstudiante(): FormArray {
  //   let i = 0;
  //   const planificaciones = this.planificacionEvaluacionForm.get('planificacionesControls') as FormArray;
  //   const evaluaciones = planificaciones.controls[i].get('planificacionEstudiante');
  //   planificaciones.get('');
  //   i += 1;
  //   // console.log(i);
  //   // console.log(this.planificacionEvaluacionForm);
  ...
  addPlanificacion() {
    ...
    if (this.planificacionEvaluacionForm.valid) {
        this.planificacionesControls.push(
          this.fb.group({
            id: 0,
            grupoID: this.planificacionEvaluacionForm.get('grupoID').value,
            planificacionID: this.planificacionEvaluacionForm.get('planificacionID').value,
            horarioID: ['', Validators.required],
            docenteID: ['', Validators.required],
            salonID: ['', Validators.required],
            asignaturaID: ['', Validators.required],
      ...
      this.planificacionService.getPlanificacionEvaluacionByGrupo(grupoSelected).subscribe(
        (  planificacionEvaluacion: PlanificacionEvaluacion[] ) => {
          ...
          if (this.planificacionEvaluaciones.length > 0 ) {
            ...
            // this.planificacionEvaluacionForm.setControl('planificacionesControls', planFormArray);
            ...
            this.planificacionEvaluacionForm.setControl('planificacionesControls', this.fb.array([]));
          }
        }
      );
  ...
  getPlanificacionEvaluacionByGrupo(grupoID: number) {
    this.planificacionService.getPlanificacionEvaluacionByGrupo(grupoID).subscribe(
      (  planificacionEvaluacion: PlanificacionEvaluacion[] ) => {
        this.planificacionEvaluaciones = planificacionEvaluacion;
      }
    );
...
//        this.router.navigate(['/planificaciones']);
  ...
  prepareSavePlanificacion(): PlanificacionEvaluacion[] {
    ...
    const planificacionDeepCopy: PlanificacionEvaluacion[] = formModel.planificacionesControls
