...
const routes: Routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: './planificacion-evaluacion/planificacion-evaluacion.module#PlanificacionEvaluacionModule'
            },
            { path: 'reporte', loadChildren: './report/report.module#ReportModule' },
